              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => BuyNowScreen(
                    property: widget.property, startDate: startDate,
                    endDate: endDate!, total: price,
                  ),
                ),
              );
            } else {
              UiUtils.setSnackBar("Attention", "Selectionnez vos dates de séjours avant de continuer s'il vous plaît", context, false);
            }
          },
          child: ClipPath(
